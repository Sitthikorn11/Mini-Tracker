  ...
  <div class="p-6 max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
      <div class="p-6 border-b border-slate-100">
        ...
        <p class="text-sm text-slate-500">Update your account name. Email cannot be changed.</p>
      </div>
      ...
      <form @submit.prevent="updatePassword" class="p-6 space-y-4">
        <div>
          ...
          <input v-model="passwordForm.current_password" type="password" required
            class="w-full md:w-1/2 px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all" />
        </div>
        ...
        <div class="pt-4 flex justify-end">
          <button type="submit" :disabled="passwordLoading" class="px-6 py-2 bg-slate-800 hover:bg-slate-900 text-white rounded-lg font-medium shadow-sm transition-colors flex items-center">
